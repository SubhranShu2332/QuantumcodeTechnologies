...
<html lang="en">
  <head>
    ...
    />
    <title>Social Services Signup</title>
    <link
      rel="stylesheet"
    ...
    <link rel="stylesheet" href="signupSocial.css" />
  ...
  <body onload="generate()">
    ...
    <div class="bg">
      ...
      <div class="parent">
        <form id="form" action="addSocial.php" method="post" enctype="multipart/form-data">
          <h1><b>Social Services</b></h1>
          ...
          <input
            ...
            required
          /><br />
          <label for="">Caste Certificate:</label>
          <input
            type="file"
            id="caste"
            name="caste"
